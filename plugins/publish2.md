...
The [Publish2](https://github.com/qor/publish2) Plugin is the successor to [Publish](https://github.com/qor/publish). It generalizes publishing using 3 important modules:
...
Last, Setup [QOR Admin](../chapter2/setup.md)
...
The section in new/edit page

![publish2-section-edit](publish2-section-intro.png)
...
![publish2-section-index](publish2-index.png)
