...
To use [I18n](https://github.com/qor/i18n) with [QOR](https://github.com/qor/qor), simply add it as resource to the [QOR Admin](https://github.com/qor/admin):
...
You could manage translations with [QOR Admin](https://github.com/qor/admin) interface after register it into [QOR Admin](https://github.com/qor/admin), But usually hard to translate a translation without its context, the inline edit is made to resolve the problem.
