...
By default, [QOR](https://github.com/qor/qor) will only allow you manage the global language. If you have configured [Authentication](../plugins/authentication.md), [QOR Admin](../chapter2/setup.md) will try to get allowed locales from the current user.
